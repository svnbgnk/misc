                                         ...
                                         TDir const & /**/)
{
    ...
    bool not_at_end = std::is_same<TDir, Rev>::value && needleRightPos != length(needle) + 1 || !std::is_same<TDir, Rev>::value && needleLeftPos != 0;
                                         ...
                                         TDistanceTag const &)
{
    ...
    if (goDown(iter, TDir()))
    {
        ...
        do
        {
            ...
            //Deletion
            bool not_at_end = std::is_same<TDir, Rev>::value && needleRightPos2 != length(needle) + 1 || !std::is_same<TDir, Rev>::value && needleLeftPos2 != 0;
                                 ...
                                 TDistanceTag const &)
{
    ...
    {
        bool not_at_end = std::is_same<TDir, Rev>::value && needleRightPos != length(needle) || !std::is_same<TDir, Rev>::value && needleLeftPos != 1;
        // Insertion
        if (std::is_same<TDistanceTag, EditDistance>::value && not_at_end)
        {
